...
//url = "http://localhost:7476/db/data/ext/TNRS/graphdb/doTNRSForNames";
url = "http://opentree-dev.bio.ku.edu:7476/db/data/ext/TNRS/graphdb/doTNRSForNames";
    ...
    $(document).ready( function(){
        ...
        for(var i = 0; i < respData.results.length; i++) {
            ...
            for (var j = 0; j < matches.length; j++) {
                ...
                thisMatchResult.append(matchForm).append("<span class='matchname'>"+thisMatch.matchedName+"</span>").append("<span>"+thisMatch.parentName+"</span>").append("<span>"+thisMatch.nomenCode+"</span>").append("<span>"+roundDecimal(thisMatch.score,3)+"</span>");
